...
namespace ENB_API
{
	...
	public:
		...
		unsigned long GetWeatherCurrent()
		{
			return std::bit_cast<unsigned long>(GetState(ENBStateType::ENBState_ulWeatherCurrent));
		}

		unsigned long GetWeatherOutgoing()
		{
			return std::bit_cast<unsigned long>(GetState(ENBStateType::ENBState_ulWeatherOutgoing));
		}

		float GetWeatherTransition()
		{
			return std::bit_cast<float>(GetState(ENBStateType::ENBState_fWeatherTransition));
		}

		float GetGameTime()
		{
			return std::bit_cast<float>(GetState(ENBStateType::ENBState_fTimeOfDay));
		}
		...
		ENBTimeOfDay2 GetTimeOfDay2()
		{
			return {
				...
				std::bit_cast<float>(GetState(ENBStateType::ENBState_fTODFactorDusk)),
				std::bit_cast<float>(GetState(ENBStateType::ENBState_fTODFactorNight)),
				std::bit_cast<float>(GetState(ENBStateType::ENBState_fTODFactorInteriorDay)),
				std::bit_cast<float>(GetState(ENBStateType::ENBState_fTODFactorInteriorNight)),
				std::bit_cast<float>(GetState(ENBStateType::ENBState_fNightDayFactor)),
				std::bit_cast<float>(GetState(ENBStateType::ENBState_fInteriorFactor)),
			};
		}

		unsigned long GetWorldSpaceID()
		{
			return std::bit_cast<unsigned long>(GetState(ENBStateType::ENBState_ulWorldSpaceID));
		}

		unsigned long GetLocationID()
		{
			return std::bit_cast<unsigned long>(GetState(ENBStateType::ENBState_ulLocationID));
		}
